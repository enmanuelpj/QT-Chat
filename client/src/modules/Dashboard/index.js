...
const Dashboard = () => {
  ...
  return (
    <div className="w-screen flex">
        <div className="w-[25%] h-screen bg-secondary overflow-scroll">
            <div className="flex items-center my-8 mx-14">
                ...
                <div className="ml-8">
                    ...
                    <p className="text-lg font-light">Mi Cuenta</p>
                </div>
            </div>
            <hr/>
            <div className="mx-14 mt-10">
                <div className="text-primary text-lg">Mensajes</div>
                <div>
                    {
                ...
                <div className="p-14"> 
					{
						...
						messages.messages.map(({ message, user : { id } = {} }) => {
							return(
								<>
									<div className={`max-w-[40%] rounded-b-xl p-4 mb-6 ${ id === user?.id ? 'bg-primary rounded-tl-xl ml-auto text-white' : 
									'bg-secondary rounded-tr-xl' } `}>{message}</div>
									<div ref={messageRef}></div>
								</>
							)
						}) : <div className="text-center text-lg font-semibold mt-24">Sin Mensajes o Sin Conversación Seleccionada</div>
					}
				</div>
            </div>
						{
							...
							<div className="p-14 w-full flex items-center">
									<Input placeholder="Escriba un mensaje..." value={message} onChange={(e) => setMessage(e.target.value)} className="w-[75%]" inputClassName="p-4 border-0 shadow-md
        ...
        <div className="w-[25%] h-screen bg-light px-8 py-9 overflow-scroll">
					<div className='text-primary text-lg px-9 py-16'>Contactos</div>
					<div>
									{
										users.length > 0 ?
